...
from astrbot.core.star import session_plugin_manager as session_plugin_manager_module
from astrbot.core.star.session_plugin_manager import SessionPluginManager


@pytest.mark.asyncio
async def test_filter_handlers_respects_enabled_plugins(monkeypatch: pytest.MonkeyPatch):
    ...
    filtered = await SessionPluginManager.filter_handlers_by_session(event, handlers)
